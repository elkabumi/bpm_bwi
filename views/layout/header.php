...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Sistem Informasi EMS E-Montoring System</title>
            ...
            <a href="../index.php" class="logo" >
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                  ...
                  <td width="86%" align="center"><span style="font-size:14px; font-weight:bold; color:#FFF">EMS</span><br><span style="font-weight:bold;">E-Monitoring System</span></td>
              </tr>
              </tr>
            </table>
