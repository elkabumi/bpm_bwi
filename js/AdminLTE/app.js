...
$(function() {
    ...
    $("[data-widget='collapse']").click(function() {
		...
		if (!box.hasClass("collapsed-box")) {
            ...
            bf.slideUp();
			$(document.getElementsByClassName("table_1")).show();
        } else {
	...
	$("[data-widget='collapse1']").click(function() {
	 ...
	 $("[data-widget='collapse2']").click(function() {
		...
		if (!box.hasClass("collapsed-box")) {
            box.addClass("collapsed-box");
            bf.slideUp();
			$(document.getElementsByClassName("table_2")).show();
        } else {
            box.removeClass("collapsed-box");
            bf.slideDown();
	 ...
	 $("[data-widget='collapse3']").click(function() {
        $(document.getElementsByClassName("togle_3")).show();
		//Find the box parent        
        var box = $(this).parents(".box").first();
        //Find the body and the footer
		...
		if (!box.hasClass("collapsed-box")) {
            box.addClass("collapsed-box");
            bf.slideUp();
			$(document.getElementsByClassName("table_3")).show();
        } else {
            box.removeClass("collapsed-box");
            bf.slideDown();
